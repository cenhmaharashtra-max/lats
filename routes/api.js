...
router.post('/nh', requireAdmin, async (req,res) => {
  try {
    ...
    const r = await pool.query(
      ...
      [nh_number,description||null,chainage_from!==undefined&&chainage_from!==''?chainage_from:null,chainage_to!==undefined&&chainage_to!==''?chainage_to:null,length||null,state||null]
    );
    res.json(r.rows[0]);
  } catch(e) { res.status(500).json({error:e.message}); }
});
router.put('/nh/:id', requireAdmin, async (req,res) => {
  try {
    ...
    const r = await pool.query(
      ...
      [nh_number,description||null,chainage_from!==undefined&&chainage_from!==''?chainage_from:null,chainage_to!==undefined&&chainage_to!==''?chainage_to:null,length||null,state||null,req.params.id]
    );
    res.json(r.rows[0]);
  } catch(e) { res.status(500).json({error:e.message}); }
});
...
router.post('/nh/:nhId/stretches', requireAdmin, async (req,res) => {
  try {
    ...
    const r = await pool.query(
      ...
      [req.params.nhId,name||null,chainage_from!==undefined&&chainage_from!==''?chainage_from:null,chainage_to!==undefined&&chainage_to!==''?chainage_to:null,length||null,description||null,district||null,taluka||null,division||null,project_id||null]
    );
    res.json(r.rows[0]);
  } catch(e) { res.status(500).json({error:e.message}); }
});
router.put('/nh/stretches/:id', requireAdmin, async (req,res) => {
  try {
    ...
    const r = await pool.query(
      ...
      [name||null,chainage_from!==undefined&&chainage_from!==''?chainage_from:null,chainage_to!==undefined&&chainage_to!==''?chainage_to:null,length||null,description||null,district||null,taluka||null,division||null,project_id||null,req.params.id]
    );
    res.json(r.rows[0]);
  } catch(e) { res.status(500).json({error:e.message}); }
});
