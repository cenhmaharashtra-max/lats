...
router.post('/save', requireAuth, async (req,res) => {
  ...
  try {
    ...
    await ups('lats_pjm_guts',['id','pjm_id','gut_number','mod_area','is_addl'],
      (d.processJMGuts||[]).map(g=>({id:g.id,pjm_id:g.processJMId,gut_number:g.gutNumber,mod_area:g.modArea||null,is_addl:g.isAddl||false}))
    );
